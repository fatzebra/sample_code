...
function scaSuccess(event) {
  console.log('scaSuccess');
  console.log(JSON.stringify(event.detail))
}

function scaError(event) {
  console.log('scaError');
  console.log(JSON.stringify(event.detail))
}
...
const verifyCard = function () {
  ...
  // 1. verifyCard called
  // 2. subscribe -> fz.sca.success
  // 3. subscribe -> fz.sca.error
  // 4. Event: fz.sca.error
  // 5. verifyCard called again
  // 6. subscribe -> fz.sca.success
  // 7. subscribe -> fz.sca.error
  // 8. Event: fz.sca.success

  // fz.off('fz.sca.success', scaSuccess)
  fz.onOnce('fz.sca.success', scaSuccess)

  // fz.off('fz.sca.error', scaError)
  fz.onOnce('fz.sca.error', scaError)
